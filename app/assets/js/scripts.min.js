      ...
      $("[data-sub-nav] > li").mouseenter(function() {
        ...
        $(window).scroll(function() {
           if($(window).scrollTop() > 335) {
             $(".addCardContainer").addClass("fixed").css({"z-index":"98"});
           } else {
...
function popupdymention(fid) {
  divclass = fid.replace('#', '');
  a = $("#"+divclass).find("[mega-data] ul").outerHeight();
  b = $("#"+divclass).find(".bottom-bar").outerHeight();
  c = $("#"+divclass).find("[cat-headding]").outerHeight();
  d = a + b + c + 70
  console.log(a, b, c);
  $("#"+divclass).find("[mega-data]").css({"height": d});
}
...
extrapopup();
function extrapopup() {
  $(".extraPopButton").on("click", function(){
    $(".extraContainer").after("<div extra-overlay></div>");
    $(".extraContainer").fadeIn(500);
    $("html").css({"overflow":"hidden"});
  });
  //
  $(document).on("click", "[data-extra-close], [extra-overlay]", function(){
    $("html").removeAttr("style");
    $("[extra-overlay]").remove();
    $(".extraContainer").fadeOut(500);
  });
}
// sylabus popup
sylabuspopup();
function sylabuspopup() {
  $("#sylabusButton").on("click", function(){
    $(".syllabusContainer").after("<div syllabus-overlay></div>");
    $(".syllabusContainer").fadeIn(500);
    $("html").css({"overflow":"hidden"});
  });
  //
  $(document).on("click", "[data-extra-close], [syllabus-overlay]", function(){
    $("html").removeAttr("style");
    $("[syllabus-overlay]").remove();
    $(".syllabusContainer").fadeOut(500);
  });
}
// Search popup on Desktop
searchDesktop();
function searchDesktop() {
  $(".search-desktop > a, [data-search]").on("click", function(){
    $(".search-desktop-popup").after("<div searchDesktop-overlay></div>");
    $(".search-desktop-popup").fadeIn(500);
    $("html").css({"overflow":"hidden"});
  });
  //
  $(document).on("click", "[searchDesktop-overlay]", function(){
    $("html").removeAttr("style");
    $(this).remove();
    $(".search-desktop-popup").fadeOut(500);
  });
}
// on change
onchange();
function onchange() {
  $(".mtabDropdown").on('change', function () {
      var opid = $(this).find('option:selected').attr('tab-id');
      //alert($(this).find('option:selected').attr('id'));
      $(".tab-content .tabDataContainer").removeClass("active");
...
function onchange2() {
  $(".mtabDropdown").on('change', function () {
      var opid = $(this).find('option:selected').attr('tab-id');
      //alert($(this).find('option:selected').attr('id'));
      $(".productTab .tabDataContainer").fadeOut(100);
      $(opid).fadeIn(500);
...
rating();
function rating() {
  $("[rating] > a > .fa").mouseenter(function(){
    $(this).addClass("fa-star");
    $(this).removeClass("fa-star-o");
  });
  $("[rating] > a > .fa").mouseleave(function(){
...
reply();
function reply(){
  $(".reply").on("click", function(reply){
    reply.preventDefault();
    $(".replayComment").removeClass("hide");
  });
}
// extra popup
extpopup();
function extpopup(){
  var extraContainerH = $(".extraContainer").height();
  var popHeaddingH = $(".popHeadding").height();
  var exDynaHedight = extraContainerH - popHeaddingH
  $(".ext-data-container").css({"height": exDynaHedight});
}
// loader
$(window).load(function() {
  $("[loader]").fadeOut(500);
